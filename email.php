...
// This version now scrubs dangerous strings form the submitted input.
...
* The clean version may either be an empty string or
...
*/
	...
	if (!empty($scrubbed['name']) && !empty($scrubbed['email']) && !empty($scrubbed['comments']) ) {
		...
		// Send the e-mail:
		mail('pgzink@gmail.com', 'Contact Form Submission', $body, "From: {$scrubbed['email']}");
